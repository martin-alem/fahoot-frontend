...
const FallBackUIOnError: React.FC<IFallBackUIOnErrorProps> = ({ resetErrorBoundary }) => {
  return (
    <main className="grid min-h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="mt-6 text-base leading-7 text-gray-600">We're sorry for the inconvenience. We are working to get it fixed.</p>
